...
\begin{itemize}[leftmargin=1.4em, itemsep=2pt]
  \item \textbf{Attack half.} Twenty prompt-transformation techniques (17 after the post-evaluation trim described below), each wrapping the same fifty AdvBench harmful goals in a different structural trick --- an encoding, a persona, an injected instruction, or a stack of all three.
